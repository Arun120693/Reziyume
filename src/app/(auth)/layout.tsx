      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="flex flex-col items-center gap-3">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center neo-raised"
            style={{ background: "linear-gradient(135deg, #7c6ff7 0%, #e879a0 100%)", boxShadow: "0 8px 24px rgba(124,111,247,0.4)" }}
          >
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
              <path d="M4 6h16M4 10h10M4 14h12M4 18h8" stroke="white" strokeWidth="2.5" strokeLinecap="round"/>
            </svg>
          </div>
          <h2 className="text-3xl font-extrabold tracking-tight" style={{ color: "#2d2b3d" }}>
            ResumeForge
          </h2>
